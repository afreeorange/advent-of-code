...
/**
 * Now start moving things! It's easy with our nice data structure! 🥂 This
 * is Part 2 where we're 'chunking' the topmost things/crates to move.
 */
instructions.map((i) => {
  let _ = stackState[i.from].splice(-i.quantity);
